...
export function ApplyButton({ collegeId, requirements, applicationsOpen }: ApplyButtonProps) {
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-2xl">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Upload all the required documents below. Ensure your files are clear and correct.
                    </DialogDescription>
                </DialogHeader>
                <ApplyForm 
                    collegeId={collegeId} 
