    ...
    <div className="flex min-h-screen flex-col bg-background text-foreground">
      ...
      <main className="flex-grow">
        <section className="relative py-20 md:py-32 text-center bg-background">
          <div className="absolute inset-0 opacity-5" style={{ backgroundImage: "url('https://placehold.co/1920x1080.png')", backgroundSize: 'cover', backgroundPosition: 'center' }} data-ai-hint="monochrome abstract pattern"></div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
              {universityData.map((uni, index) => (
                <Card key={index} className="flex flex-col overflow-hidden rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 bg-card text-card-foreground border-border">
